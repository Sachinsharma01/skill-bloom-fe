...
const Contact = () => {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-brand-blue-dark to-brand-blue-light text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">Get in Touch</h1>
        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 space-y-6 mb-8">
              <h3 className="text-2xl font-serif font-bold text-brand-blue-dark mb-6">Contact Information</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <ContactInfo icon={<Mail size={20} />} title="Email Us">
                  ...
                  <br />
                  <a href="mailto:support@eduplatform.com" className="hover:text-brand-teal transition-colors">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8">
              <h3 className="text-2xl font-serif font-bold text-brand-blue-dark mb-6">Connect With Us</h3>
              <p className="text-sm text-gray-600 mb-4">
                Follow us on social media to stay updated with the latest courses, educational content, and offers.
              </p>

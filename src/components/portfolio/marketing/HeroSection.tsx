      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center text-white">
        ...
        <div className="flex flex-col gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-4 sm:px-0">
          ...
          <Button 
            ...
            size="lg"
            className="w-full bg-yellow-400 sm:w-auto text-base text-black sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-full border-white/30 text-white hover:bg-white/10 backdrop-blur"
          >
            See Live Demo
          </Button>
        </div>
